...
{
    /// <summary>
    ///     This Brush instances and places a containing prefab onto the targeted location and parents the instanced object to
    ///     the paint target.
    /// </summary>
    ...
    public class PrefabBrush : BasePrefabBrush
    {
        ...
        public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
        {
            ...
            var existPrefabObjectInCell = objectsInCell.Any(objectInCell =>
                PrefabUtility.GetCorrespondingObjectFromSource(objectInCell) == m_Prefab);

            if (!existPrefabObjectInCell) InstantiatePrefabInCell(grid, brushTarget, position, m_Prefab, m_Rotation);
        }
